...
/// App color palette - Minimalist and modern design system
/// Usage: AppColors.primary, AppColors.light.background, AppColors.dark.surface
class AppColors {
  AppColors._();
  ...
  /// Secondary brand color - Green (success/accent)
...
extension AppColorsExtension on BuildContext {
  /// Get the current theme's color set
...
/// Unified color set that adapts to theme
class AppColorSet {
