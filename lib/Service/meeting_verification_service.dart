...
/// MeetingVerificationService handles meeting photo verification
/// Endpoints: /api/v1/meeting-verification/*
class MeetingVerificationService {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // UPLOAD START PHOTO - Upload meeting start verification photo
  // Endpoint: POST /api/v1/meeting-verification/{bookingId}/start-photo
  // ═══════════════════════════════════════════════════════════════════════════
  static Future<MeetingVerificationResponse> uploadStartPhoto(
    ...
    try {
      ...
      print('========== POST Start Photo Request ==========');
      print('URL: $url');
      ...
      print('========== POST Start Photo Response ==========');
      ...
      print('POST Start Photo Error: $e');
      return MeetingVerificationResponse(
        success: false,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // UPLOAD END PHOTO - Upload meeting end verification photo
  // Endpoint: POST /api/v1/meeting-verification/{bookingId}/end-photo
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // GET VERIFICATION STATUS - Get meeting verification status
  // Endpoint: GET /api/v1/meeting-verification/{bookingId}/status
  // ═══════════════════════════════════════════════════════════════════════════
  static Future<VerificationStatusResponse> getVerificationStatus(int bookingId) async {
    try {
      ...
      print('========== GET Verification Status Request ==========');
      print('URL: $url');
      print('=====================================================');
      ...
      print('========== GET Verification Status Response ==========');
      print('Status Code: ${response.statusCode}');
      print('Body: ${response.body}');
      print('======================================================');
...
/// Verification data from upload response
class MeetingVerificationData {
  final int? bookingId;
  final String? photoUrl;
  final String? photoType; // 'start' or 'end'
...
class VerificationStatus {
  final int bookingId;
  final String? overallStatus; // 'pending', 'in_progress', 'completed', 'failed'
  ...
  factory VerificationStatus.fromJson(Map<String, dynamic> json) {
    return VerificationStatus(
      ...
      actualDurationHours: json['actual_duration_hours'] != null
          ? (json['actual_duration_hours']).toDouble()
          : null,
    );
  }
