...
class _AboutScreenState extends State<AboutScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonIconSize = isDesktop ? 26.0 : isTablet ? 24.0 : isSmallScreen ? 20.0 : 22.0;
    
    // Grid columns for values section
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCallToAction(
                    ...
                    isDark,
                    cardRadius: cardRadius,
                    cardPadding: horizontalPadding + 8,
                    titleFontSize: cardTitleFontSize + 2,
                    bodyFontSize: bodyFontSize,
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Ready to Find Your Perfect Friends?',
              style: TextStyle(
                fontSize: titleFontSize,
                fontWeight: FontWeight.bold,
                color: colors.textPrimary,
            ...
            SizedBox(height: itemSpacing),
            Text(
              'Join thousands of people who have found great friendships through SettingWala. Your perfect friends are waiting for you.',
              style: TextStyle(
                fontSize: bodyFontSize,
                color: colors.textSecondary,
                height: 1.5,
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Navigating to Events page...')),
                  );
                },
                icon: Icon(Icons.event, size: buttonIconSize),
                label: Text(
                  'Explore Events',
