...
class _FindPersonPageState extends State<FindPersonPage> with SingleTickerProviderStateMixin {
  ...
  Map<String, dynamic> _userToMap(User user) {
    ...
    String getFullImageUrl(String? url) {
      ...
      return 'https://settingwala.com$cleanUrl';
    }
  ...
  Widget build(BuildContext context) {
    ...
    // Responsive values for main layout
    ...
    // Responsive values for results header
    ...
    // Responsive values for filter button
    ...
    return Scaffold(
      body: Padding(
        ...
        // Scrollable page - SingleChildScrollView ma wrap karyu
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // Filter Button - Click kare toj filter bottom sheet open thay
                      GestureDetector(
              ...
              if (_isLoading)
                ...
                // People Grid - shrinkWrap karyu scrolling mate
                GridView.builder(
                  shrinkWrap: true,
  ...
  // Bottom Sheet ma Filters show karo
  void _showFiltersBottomSheet() {
    // Theme setup for bottom sheet
    final colors = context.colors;
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final primaryColor = isDark ? AppColors.primaryLight : AppColors.primary;
    ...
    // Responsive bottom sheet values
    ...
    // Temporary filter values for bottom sheet
    ...
    // Temporary controllers for TextFormField
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Gender TextFormField with dropdown
                          ...
                          // Location TextFormField with dropdown
                          _buildBottomSheetTextFormField(
                            'Location',
  ...
  // Bottom Sheet TextFormField Widget with dropdown
  ...
  // Show selection dialog for TextFormField
  ...
  // Bottom Sheet Date Picker Widget
  ...
  // Bottom Sheet Time Picker Widget
  ...
  // Bottom Sheet Price Slider Widget
