...
class _FindPersonScreenState extends State<FindPersonScreen> with TickerProviderStateMixin {
  ...
  List<Map<String, dynamic>> get filteredPeople {
    ...
    return _people.where((person) {
      ...
      bool matchesSearch = _searchController.text.isEmpty || 
          person['name'].toLowerCase().contains(_searchController.text.toLowerCase()) ||
          person['location'].toLowerCase().contains(_searchController.text.toLowerCase());
      ...
      bool matchesLocation = _locationFilter.isEmpty || 
          person['location'].toLowerCase().contains(_locationFilter.toLowerCase());
      
      // Filter by price range
      bool matchesPrice = person['price'] >= _priceRange.start && 
          person['price'] <= _priceRange.end;
      
      // For date and time, we would need actual availability data
  ...
  Map<String, dynamic> _userToMap(User user) {
    ...
    return {
      ...
      // Time Spending fields - for showing Book Time button
  ...
  void _showFilterBottomSheet() {
    // Create local controller for location
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Person Image - Fixed height with Expanded
            Expanded(
              flex: 3,
              child: Stack(
                children: [
