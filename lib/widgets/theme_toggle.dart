...
/// A widget to toggle between light, dark, and system themes
/// 
/// Usage:
/// ```dart
/// ThemeToggle() // Simple toggle switch
/// ThemeToggle.segmented() // Segmented button with all options
/// ThemeToggle.listTile() // ListTile for settings screen
/// ```
class ThemeToggle extends StatelessWidget {
  ...
  /// Creates a segmented button with Light, Dark, and System options
  static Widget segmented() => const _ThemeSegmentedButton();

  /// Creates a ListTile suitable for settings screens
  ...
  /// Creates a dropdown menu for theme selection
