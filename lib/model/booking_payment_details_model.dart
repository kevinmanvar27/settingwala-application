// Booking Payment Details Model
// GET /api/v1/bookings/{id}/payment - Get complete payment details for a booking
...
class BookingPaymentDetails {
  ...
  // Amount Details - matches Laravel getPaymentDetails response
  ...
  // Cashfree Order Details (when payment required)
